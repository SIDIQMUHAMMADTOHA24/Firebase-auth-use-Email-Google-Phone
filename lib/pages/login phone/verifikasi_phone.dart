...
import 'package:firebase_auth_new/pages/login%20phone/login_by_phone_pages.dart';
                      ...
                      try {
                        PhoneAuthCredential credential =
                            PhoneAuthProvider.credential(
                                verificationId:
                                    LoginByPhonePages.verificationId,
                                smsCode: code);
                        ...
                        print(
                            'berhasil masuk ke : ${FirebaseAuth.instance.currentUser!.phoneNumber}');
                        Navigator.pop(context);
                      } catch (e) {
                        print(e.toString());
                        print('eror');
